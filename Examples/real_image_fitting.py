...
imageio.mimsave('Examples/outputs/photo_training_process.gif', gif_images, duration=duration, loop=0)
...
plt.tight_layout()
plt.savefig("Examples/outputs/photo_demo_training_loss_badangle.png", bbox_inches='tight')